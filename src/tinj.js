...
//
export function tinj(t, inj) {
    for (let i=0; i<t; i++) { globalThis['tinj'+i] = null; }
    globalThis['tinj'+t] = inj;
    for (let i=t+1; i<10000; i++) { globalThis['tinj'+i] = null; }
}
if (typeof globalThis['tinj0'] === 'undefined') tinj(0, null);
